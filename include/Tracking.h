...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        Tracking(System *pSys, ORBVocabulary *pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Atlas *pAtlas,
                 KeyFrameDatabase *pKFDB, const string &strSettingPath, int sensor, Settings *settings, const string &_nameSeq = std::string());
...
//      Preprocess the input and call Track(). Extract features and performs stereo matching.
        ...
        [[maybe_unused]] bool GetStepByStep() const;
...
//      std::mutex mMutexTracks;
        ...
        [[maybe_unused]] int GetNumberDataset() const;

        int GetMatchesInners() const;

//      DEBUG
        [[maybe_unused]] void SaveSubTrajectory(const string& strNameFile_frames, const string& strNameFile_kf, const string& strFolder = "");

        [[maybe_unused]] void SaveSubTrajectory(const string& strNameFile_frames, const string& strNameFile_kf, Map *pMap);
