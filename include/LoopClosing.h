...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        typedef map<KeyFrame *, g2o::Sim3, std::less<>, Eigen::aligned_allocator<std::pair<KeyFrame *const, g2o::Sim3> > > KeyFrameAndPose;

    public:
        LoopClosing(Atlas *pAtlas, KeyFrameDatabase *pDB, ORBVocabulary *pVoc, bool bFixScale, bool bActiveLC);
...
//      Methods to implement the new place recognition algorithm
        ...
        static bool DetectCommonRegionsFromLastKF(KeyFrame *pCurrentKF, KeyFrame *pMatchedKF, g2o::Sim3 &gScw, int &nNumProjMatches,
                                           std::vector<MapPoint *> &vpMPs, std::vector<MapPoint *> &vpMatchedMPs);

        static int FindMatchesByProjection(KeyFrame *pCurrentKF, KeyFrame *pMatchedKFw, g2o::Sim3 &g2oScw,
                                    set<MapPoint *> &spMatchedMPinOrigin, vector<MapPoint *> &vpMapPoints,
                                    vector<MapPoint *> &vpMatchedMapPoints);

        static void SearchAndFuse(const KeyFrameAndPose &CorrectedPosesMap, vector<MapPoint *> &vpMapPoints);

        static void SearchAndFuse(const vector<KeyFrame *> &vConnectedKFs, vector<MapPoint *> &vpMapPoints);
        ...
        static void CheckObservations(set<KeyFrame *> &spKFsMap1, set<KeyFrame *> &spKFsMap2);
