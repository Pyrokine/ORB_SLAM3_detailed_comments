...
//      Initialize the SLAM system. It launches the Local Mapping, Loop Closing and Viewer threads.
        System(const string &strVocFile, const string &strSettingsFile, eSensor sensor, bool bUseViewer = true, int initFr = 0, const string &strSequence = std::string());
...
//      Process the given rgbd frame. Depth map must be registered to the RGB frame.
